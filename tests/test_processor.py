...
class TestProcessor(TestCase):
    def test_init(self):
        ...
        self.assertRaises(ValueError, lambda: Processor(**kwargs))
    ...
    def test_to_date(self):
        ...
        self.assertEqual(Processor._to_date(np_date), obj_date)
        self.assertEqual(Processor._to_date(str_date), obj_date)
        self.assertEqual(Processor._to_date(df_date), obj_date)
